...
list<Token>::const_iterator Parser::curTokenPos;

void Parser::syntaxError(const string& message, ostream& out) {
	out << endl << ">>> "
...
shared_ptr<TreeNode> Parser::stmt_sequence(void) {
...
shared_ptr<TreeNode> Parser::statement(void) {
...
shared_ptr<TreeNode> Parser::if_stmt(void) {
...
shared_ptr<TreeNode> Parser::repeat_stmt(void) {
...
shared_ptr<TreeNode> Parser::assign_stmt(void) {
...
shared_ptr<TreeNode> Parser::read_stmt(void) {
...
shared_ptr<TreeNode> Parser::write_stmt(void) {
...
shared_ptr<TreeNode> Parser::exp(void) {
...
shared_ptr<TreeNode> Parser::simple_exp(void) {
...
shared_ptr<TreeNode> Parser::term(void) {
...
shared_ptr<TreeNode> Parser::factor(void) {
	shared_ptr<TreeNode> t =nullptr;
	switch (curToken.token) {
	case NUM:
		t = newExpNode(ConstK);
 ...
 */
 shared_ptr<TreeNode> Parser::parse(void) {
	shared_ptr<TreeNode> t = nullptr;
